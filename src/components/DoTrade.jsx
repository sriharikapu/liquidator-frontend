...
class DoTrade extends Component {
  ...
  hasTxCompleted = type => {
    return (
      this.props.transactions[type] &&
      this.props.transactions[type].tx &&
      !this.props.transactions[type].pending &&
      !this.props.transactions[type].error &&
      (type !== "trade" ||
        this.props.transactions.trade.amountBuy.gt(0) ||
        this.props.transactions.trade.amountSell.gt(0))
    );
  };
        ...
        <div className="content">
          {this.props.trade.txs === 3 && (
            <a
              href={
                typeof this.props.transactions.proxy !== "undefined" &&
                this.props.transactions.proxy.tx
                  ? `${etherscanUrl(this.props.network)}/tx/${
                      this.props.transactions.proxy.tx
                    }`
                  : "#"
              }
              className={`tx ${
                this.props.transactions.proxy &&
                this.props.transactions.proxy.tx
                  ? "clickable"
                  : "non-clickable"
              }`}
            ...
            >
              <div className="transaction-info-box">
                <div className="operation">
                  <span
                    className={`icon ${
                      this.hasTxCompleted("proxy") ? "success" : ""
                    }`}
                  >
                    <AccountIcon />
                  </span>
                  <span className="label vertical-align">
                    ...
                    >
                      <p>
                        Proxy is a supporting contract owned by you that groups
                        different actions as one Ethereum transaction.
                      </p>
                    </ReactTooltip>
                  </span>
                  {typeof this.props.transactions.proxy === "undefined" ? (
                    ...
                    <React.Fragment>
                      <span className="status label">Signing transaction</span>
                      <Spinner />
                    </React.Fragment>
          ...
          {this.props.trade.txs >= 2 && (
            <a
              href={
                typeof this.props.transactions.approval !== "undefined" &&
                this.props.transactions.approval.tx
                  ? `${etherscanUrl(this.props.network)}/tx/${
                      this.props.transactions.approval.tx
                    }`
                  : "#"
              ...
              className={`tx ${
                this.props.transactions.approval &&
                this.props.transactions.approval.tx
                  ? "clickable"
                  : "non-clickable"
              }`}
            ...
            >
              <div className="transaction-info-box">
                <div className="operation">
                  <span
                    className={`icon done ${
                      this.hasTxCompleted("approval") ? "success" : ""
                    }`}
                  >
                    <Done />
                  </span>
                  <span className="label vertical-align">
                    ...
                    >
                      <p>
                        Enabling token trading allows your Proxy to take tokens
                        from you and trade them on the exchange.
                      </p>
                    </ReactTooltip>
                  </span>
                  {typeof this.props.transactions.approval === "undefined" ? (
                    this.props.trade.txs <= 2 ||
                    /*typeof this.props.transactions.proxy.pending !== 'undefined' && */ (this
                      .props.transactions.proxy.pending === false &&
                      this.props.transactions.proxy.error === false) ? (
                      <React.Fragment>
                        <span className="status label">
                          Initiating transaction
                        </span>
          ...
          {!this.hasTxCompleted("trade") ? (
                ...
                <div className="content">
                  <span>
                    <span className="label">
                      Perhaps the market has moved, so your order could not be
                      filled within the
                    </span>
                    <span className="value">
                      {
                        settings.chain[this.props.network].threshold[
                          [this.props.trade.from, this.props.trade.to]
                            .sort((a, b) => a > b)
                            .join("")
                        ]
                      }
                          ...
                          <span className="label vertical-align">
                            ...
                            >
                              <p>
                                ...
                                groups different actions as one Ethereum
                                transaction.
                              </p>
                            </ReactTooltip>
                          </span>
                          <React.Fragment>
                            {typeof this.props.transactions.trade ===
                            "undefined" ? (
                              ...
                              <span className="status label error">Failed</span>
                            ) : this.props.transactions.trade.amountBuy.eq(
                              -1
                            ) ||
                  ...
                  <div className="operation">
                    <div className="details">
                      ...
                      <span className="value">
                        ...
                        <TokenAmount
                          number={toWei(this.props.trade.amountPay.valueOf())}
                    ...
                    <div className="details">
                      ...
                      <span className="value">
                        ...
                        <TokenAmount
                          number={toWei(this.props.trade.amountBuy.valueOf())}
            ...
            >
              <Congratulation
                ...
                } //THIS IS A FRICKIN HACK!
                isCalculatingGas={
                  (typeof this.props.transactions.approval !== "undefined" &&
                    typeof this.props.transactions.approval.gasPrice ===
                      "undefined") ||
                ...
                quotation={quotation(
                  this.props.trade.from,
                  this.props.trade.to
                )}
                gas={(typeof this.props.transactions.approval !== "undefined"
                  ? this.props.transactions.approval.gasPrice.times(
                      this.props.transactions.approval.gasUsed
                    )
                  : toBigNumber(0)
                ).add(
                  this.props.transactions.trade.gasPrice.times(
                    this.props.transactions.trade.gasUsed
                  )
                )}
              />
            </a>
