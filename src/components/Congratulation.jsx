        ...
        <div className="content">
          {this.props.hasCreatedProxy && (
            <span className="label">
              You have successfully create a{" "}
          ...
          <span className="label">
            {this.props.hasCreatedProxy ? (
              ...
              <React.Fragment>
                By using your <span className="value"> Proxy </span> you{" "}
                {this.props.quotation.isCounter ? "sold" : "bought"}
                &nbsp;
              </React.Fragment>
            )}
            <TokenAmount
              number={
                this.props.quotation.isCounter
                  ? this.props.sold
                  : this.props.bought
              }
              decimal={5}
            ...
            at&nbsp;
            <TokenAmount
              number={toWei(finalizedPrice.price)}
            ...
            <span className="value">
              {this.props.isCalculatingGas ? (
                ...
                <TokenAmount
                  number={this.props.gas * this.state.priceInUSD}
                  token={"USD"}
                />
              )}
              &nbsp;
