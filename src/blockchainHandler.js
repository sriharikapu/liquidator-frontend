...
export const getTokenTrusted = (token, from, to) => {
  return promisify(objects[token].allowance.call)(from, to).then(result =>
    result.eq(
      web3
        .toBigNumber(2)
        .pow(256)
...
export const getCallDataAndValue = (
  network,
  operation,
  from,
  to,
...
export const getActionCreateProxyAndSellETH = (
  network,
  operation,
  to,
  amount,
